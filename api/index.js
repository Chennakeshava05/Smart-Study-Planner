...
const { db, initializeDatabase } = require('../BackEnd/database');
const { router: authRoutes, authenticateToken } = require('../BackEnd/authRoutes');
const historyRoutes = require('../BackEnd/historyRoutes');
...
app.use(cors({
  origin: process.env.NODE_ENV === 'production' 
    ? ['https://your-domain.vercel.app', 'https://your-domain.vercel.app/api/*']
    : ['http://localhost:3000'],
  credentials: true
}));
